...
**`externally-managed-environment`:** Workshop pipelines use `pip3 install --break-system-packages` so pytest can install on Debian/Ubuntu hosts that enforce PEP 668.
