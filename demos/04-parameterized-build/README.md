...
| Setting | Value |
|---------|-------|
| Job name | `demo-04-parameterized-build` |
| Job type | Pipeline |
| Definition | Pipeline script from SCM |
| Repository URL | `https://github.com/learnwithraghu/jenkins-workshop.git` |
| Branch | `*/main` |
| Script Path | `demos/04-parameterized-build/Jenkinsfile` |
...
[05-post-build-artifacts](../05-post-build-artifacts/README.md) — archive build artifacts and publish test reports.
