...
| Setting | Value |
|---------|-------|
| Job name | `demo-06-multibranch-pipeline` |
...
| Script Path | `demos/06-multibranch-pipeline/Jenkinsfile` |

### Step-by-step

1. Click **New Item** → name: `demo-06-multibranch-pipeline`.
...
5. Under **Build Configuration**, set **Script Path** to `demos/06-multibranch-pipeline/Jenkinsfile`.
...
You've finished all demos. Head to the [challenges](../../challenges/README.md) to practice writing pipelines yourself.
